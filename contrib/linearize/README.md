...
https://github.com/akasproject/akas_hash
...
JSON-RPC server. Running `akaxd` or `akax-qt -server` will be sufficient.
...
* `input`: akaxd blocks/ directory containing blkNNNNN.dat
