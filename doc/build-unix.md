UNIX BUILD NOTES
====================
Some notes on how to build Akax Core in Unix.
...
-----------------------
Building the dependencies and Akax Core requires some essential build tools and libraries to be installed before.
...
Security
--------
To help make your Akax Core installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, Akax Core should be built with a non-executable stack,
