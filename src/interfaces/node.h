...
//! Interface for the src/evo part of a akax node (akaxd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a akax node (akaxd process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a akax node (akaxd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a akax node (akaxd process).
...
//! Top-level interface for a akax node (akaxd process).
class Node
{
public:
    virtual ~Node() {}
