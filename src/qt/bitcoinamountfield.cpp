...
public:
    ...
    QSize minimumSizeHint() const override
    {
        ...
        int h = 0;
        int w = GUIUtil::TextWidth(fm, BitcoinUnits::format(BitcoinUnits::AKAX, BitcoinUnits::maxMoney(), false, BitcoinUnits::separatorAlways));
