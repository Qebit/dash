...
/** Utility functions used by the Akax Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "akax:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load akax specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a akax specific theme is activated (light/dark).*/
