...
/** Utility functions used by the Xeke Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "xeke:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load xeke specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a xeke specific theme is activated (light/dark).*/
