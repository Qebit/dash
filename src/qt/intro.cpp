    ...
    m_chain_state_size(chain_state_size)
{
    ...
    ui->sizeWarningLabel->setText(
        tr("%1 will download and store a copy of the Akax block chain.").arg(PACKAGE_NAME) + " " +
...
bool Intro::pickDataDirectory(interfaces::Node& node)
{
     ...
     * override -datadir in the akax.conf file in the default data directory
     * (to be consistent with akaxd behavior)
     */
    if(dataDir != GUIUtil::getDefaultDataDirectory()) {
