    ...
    m_chain_state_size(chain_state_size)
{
    ...
    ui->sizeWarningLabel->setText(
        tr("%1 will download and store a copy of the Xeke block chain.").arg(PACKAGE_NAME) + " " +
...
bool Intro::pickDataDirectory(interfaces::Node& node)
{
     ...
     * override -datadir in the xeke.conf file in the default data directory
     * (to be consistent with xeked behavior)
     */
    if(dataDir != GUIUtil::getDefaultDataDirectory()) {
