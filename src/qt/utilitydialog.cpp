    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:  akax-qt [command-line options]                     \n";
...
All the Akax in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 AKAX, 0.01 AKAX, 0.1 AKAX, 1 AKAX and 10 AKAX -- sort of like the paper money you use every day.</li> \
