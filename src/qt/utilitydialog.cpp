    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:  xeke-qt [command-line options]                     \n";
...
All the Xeke in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 XEKE, 0.01 XEKE, 0.1 XEKE, 1 XEKE and 10 XEKE -- sort of like the paper money you use every day.</li> \
