...
"""Verify that starting akaxd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start akaxd with -h for help text")
        ...
        self.log.info("Start akaxd with -version for version information")
        ...
        self.log.info("Start akaxdd with -fakearg to make sure it does not start")
