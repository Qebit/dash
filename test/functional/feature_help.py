...
"""Verify that starting xeked with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start xeked with -h for help text")
        ...
        self.log.info("Start xeked with -version for version information")
        ...
        self.log.info("Start xekedd with -fakearg to make sure it does not start")
